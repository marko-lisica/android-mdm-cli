...
export const enterprises = (androidApi, config) => {
    ...
    .action((options) => {
        ...
        androidApi.enterprises.get({
            ...
            console.log("");
            console.error(chalk.red('Couldn\'t get enterprise:'), error.code + ": " + error.message);
        });
    });
    ...
    .action((options) => {
        ...
        androidApi.enterprises.delete({
            ...
            // Print response
            console.log("");
            console.log(chalk.blue(`'${options.id}' enterprise deleted successfully.`));
            console.log("");
        }).catch(error => {
            console.log("");
            console.error(chalk.red('Couldn\'t delete enterprise:'), error.code + ": " + error.message);
        });
    });
        ...
        .action((options) => {
            ...
            if (fs.existsSync(enterpriseFilePath)) {
                ...
                androidApi.enterprises.patch({
                    ...
                    console.log("");
                    console.log(chalk.blue(`'${options.id}' enterprise successfully updated.`));
                    console.log("")
                    console.log(response)
                    console.log("");
                }).catch(error => {
                    console.log("");
                    console.error('Couldn\'t patch enterprise:', error.code + ":", error.message);
                });
            } else {
