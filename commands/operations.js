...
export const operations = (androidApi, config) => {
    ...
    .description('Manage operations queued in your Android Enterprise.');
    ...
    operationsCommand
        ...
        .action((options) => {
            ...
            androidApi.enterprises.devices.operations.list({
                ...
                // Print response
                console.log("");
                console.log(chalk.blue(`Operations queued on ${options.device} device:`));
                console.log("");
    ...
    operationsCommand
        ...
        .action((options) => {
            ...
            androidApi.enterprises.devices.operations.get({
    ...
    operationsCommand
        ...
        .action((options) => {
            ...
            androidApi.enterprises.devices.operations.cancel({
                name: `${enterpriseName}/devices/${options.device}/operations/${options.id}`,
            }).then(() => {
                
                // Print response
                console.log("");
                console.log(chalk.blue(`'${options.id}' operation successfully canceled.`));
                console.log("");
            }).catch(error => {
